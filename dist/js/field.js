...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	mounted: function mounted() {
		...
		console.log('isNestedForm', this.isNestedForm);
		...
		registerDependencyWatchers: function registerDependencyWatchers(root, callback, onMounted) {
			...
			root.$children.forEach(function (component) {
				if (_this.componentIsDependency(component)) {
					console.log('dependency', component.field.attribute);
					...
					component.$watch(attribute, function (value) {
						console.log('value', value, _this.field.attribute);
		...
		updateDependencyStatus: function updateDependencyStatus() {
			...
			try {
				for (var _iterator2 = this.field.dependencies[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
					...
					console.log(attribute, dependencyValue, this.dependencyValues);
