...
Nova.booting(function (Vue, router) {
    Vue.component('form-nova-dependency-container', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    this.field.fields.forEach(function (f) {
      f.value = _this.field.value[f.attribute];
    });
  },
  mounted: function mounted() {
    var _this2 = this;

    this.field.dependencies.forEach(function (dependency) {
      Nova.$on(dependency.field + '-value-changed', function (e) {
        _this2.compareValues[dependency.field] = e.value;

        var vm = _this2;
        vm.show = true;
        _this2.field.dependencies.forEach(function (dependency) {
          if (dependency.notEmpty) {
            if (_this2.compareValues[dependency.field] == '' || _this2.compareValues[dependency.field] == null) {
              vm.show = false;
            }
          } else {
            if (dependency.value !== _this2.compareValues[dependency.field]) {
              vm.show = false;
            }
          }
        });
  ...
  computed: {
    childFields: function childFields() {
      return this.field.fields;
    }
  },

  methods: {
    registerValueWatchers: function registerValueWatchers(root) {
      var _this3 = this;
      ...
      root.$children.forEach(function (component) {
        if (component.constructor.options !== undefined && component.constructor.options.name !== undefined) {
          if (component.constructor.options.name.endsWith('-field') || _this3.field.depends_custom.includes(component.constructor.options.name)) {
            component.$watch('value', function (value, oldValue) {
            ...
            component.$watch('selectedResource.value', function (value, oldValue) {
              Nova.$emit(component.field.attribute + '-value-changed', {
                field: component.field,
        ...
        _this3.registerValueWatchers(component);
      });
    },
    ...
    fill: function fill(formData) {
      ...
      this.field.fields.forEach(function (f) {
        formData.append(f.attribute, _this4.$refs['field-' + f.attribute][0].value);
      });
    }
  }
});
...
var render = function() {
  ...
  return _c(
    ...
    _vm._l(_vm.childFields, function(field) {
      return _c(
        "div",
        [
