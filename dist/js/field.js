...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mixin_PackageSupport__ = __webpack_require__(9);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	__WEBPACK_IMPORTED_MODULE_1__mixin_PackageSupport__["c" /* PackageSupport */], __WEBPACK_IMPORTED_MODULE_1__mixin_PackageSupport__["b" /* NovaInlineRelationshipSupport */], __WEBPACK_IMPORTED_MODULE_1__mixin_PackageSupport__["a" /* NovaFlexibleContentSupport */]],
	...
	methods: {
		...
		componentIsDependency: function componentIsDependency(component) {
			var attributeProperty = this.field.settings.attributeProperty;
			...
			try {
				for (var _iterator = this.field.dependencies[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
					...
					// default
					var dependency_attribute = dependency.field;
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return PackageSupport; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return NovaInlineRelationshipSupport; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return NovaFlexibleContentSupport; });
var packages = {
    nova_inline: {
...
var PackageSupport = {
    ...
    methods: {
        registerPackageSupport: function registerPackageSupport(computed, package_name) {
            if (this[computed]) {
                this.addPackageSupport(package_name, packages[package_name]);
            }
        },
        addPackageSupport: function addPackageSupport(package_name, support) {
            this.compatabilityModes.push(package_name);
            this.packageSupport[package_name] = support;
        },
        getPackageSpecificAttribute: function getPackageSpecificAttribute(name) {},
        addCompatabilityMode: function addCompatabilityMode(name) {
            this.compatabilityModes.push(name);
        },
        findParentPackage: function findParentPackage(component, package_name) {
...
|
*/
var NovaInlineRelationshipSupport = {

    methods: {
        getNovaInlineAttribute: function getNovaInlineAttribute(dependency) {
            var nova_inline = this.$parent;
...
|
*/
var NovaFlexibleContentSupport = {

    methods: {
        getNovaFlexibleContentAttribute: function getNovaFlexibleContentAttribute(dependency) {
    ...
    computed: {
        is_nova_flexible_content: function is_nova_flexible_content() {
            var $parent = this.findParentPackage(this.$parent, 'nova_flexible');
