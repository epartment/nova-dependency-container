    ...
    */
			packageCompat: {
				...
				packages: {
					flexibleContent: {
						...
						check: function check(container) {
							var component = container.$parent,
							    is = void 0;

							if (is = typeof component.field !== 'undefined' && component.field.component === this.name) {
	...
	methods: {
		checkCompatability: function checkCompatability() {
			__WEBPACK_IMPORTED_MODULE_1_lodash___default.a.each(this.packageCompat.packages, function (_package) {
				_package.check(this);
			}.bind(this));
		},
		getCompatibilityCallback: function getCompatibilityCallback(callback_name) {
			if (this.compatMode !== null) {
				var callback = this.packageCompat.packages[this.compatMode].callbacks[callback_name];
		...
		fill: function fill(formData) {
			if (this.dependenciesSatisfied) {
				__WEBPACK_IMPORTED_MODULE_1_lodash___default.a.each(this.field.fields, function (field) {
					if (field.fill) {
						field.fill(formData);
					}
				});
